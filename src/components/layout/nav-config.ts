    ...
    groups: [
      {
        ...
        items: [
          ...
          { label: "Nhân viên", to: "/admin/staff", icon: UserCog },
...
export const ADMIN_PAGES: { label: string; to: string }[] = [
  ...
  { label: "Danh sách nhân viên", to: "/admin/staff" },
  { label: "Tạo nhân viên", to: "/admin/staff/create" },
  { label: "Chi tiết nhân viên", to: "/admin/staff/st1" },
  { label: "Cập nhật nhân viên", to: "/admin/staff/st1/edit" },
